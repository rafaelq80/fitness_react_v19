			...
			<div className="flex justify-center items-center w-full h-full px-8 lg:px-0">
				...
				>
					...
					<div className="text-center mb-4">
						<h2 className="text-5xl mb-2 bg-linear-to-r from-emerald-600 to-emerald-800 bg-clip-text text-transparent">
							Entrar
						</h2>
					...
					<button
						type="submit"
						disabled={isLoading}
						className="rounded-xl bg-linear-to-r from-emerald-600 to-emerald-700 flex justify-center items-center
